...
#Codigo con el errror solucionado
# import matplotlib.pyplot as plt
# import numpy as np
# import matplotlib
# import time
...
# def grafica_barras(horas_registradas, lecturas_registradas, tiempo_espera=10):
#     # Crear la gráfica de barras utilizando horas_registradas y lecturas_registradas
#     plt.figure(figsize=(19.2, 10.8))
#     indices = np.arange(len(horas_registradas))
#     plt.bar(indices, lecturas_registradas, color='blue')
#     plt.xticks(indices, horas_registradas, rotation=45)
...
# def grafica_pastel(iuv_promedio, iuv_minima, iuv_maxima, iuv_moda, tiempo_espera=10):
#     # Crear la gráfica de pastel utilizando los valores proporcionados
#     plt.figure(figsize=(19.2, 10.8))
#     etiquetas = ["IUV PROMEDIO", "IUV MINIMA", "IUV MAXIMA", "IUV MODA"]
#     valores = [iuv_promedio, iuv_minima, iuv_maxima, iuv_moda]
